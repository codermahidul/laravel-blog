        ...
        <div class="row">
                ...
                <div class="content-block post-grid post-grid-transparent">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-tect-01.jpg" alt="Post Images">
                        </a>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mt_lg--30 mt_md--30 mt_sm--30 col-12">
                ...
                <div class="content-block image-rounded">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-tect-02.jpg" alt="Post Images">
                        </a>
                    </div>
                ...
                <div class="content-block image-rounded mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-tect-03.jpg" alt="Post Images">
                        </a>
                    </div>
                    <div class="post-content pt--20">
                        <div class="post-cat">
            ...
            <div class="col-xl-3 col-md-6 mt_lg--30 mt_md--30 mt_sm--30 col-12">
                ...
                <div class="content-block image-rounded">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-tect-04.jpg" alt="Post Images">
                        </a>
                    </div>
                    <div class="post-content pt--20">
                        <div class="post-cat">
                ...
                <div class="content-block image-rounded mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-tect-05.jpg" alt="Post Images">
                        </a>
                    </div>
                    <div class="post-content pt--20">
                        <div class="post-cat">
                ...
                <div class="list-categories categories-activation axil-slick-arrow arrow-between-side">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-sm-01.jpg" alt="post categories images">
                                </div>
                                <div class="content">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-sm-02.jpg" alt="post categories images">
                                </div>
                                <div class="content">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-sm-03.jpg" alt="post categories images">
                                </div>
                                <div class="content">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-sm-04.jpg" alt="post categories images">
                                </div>
                                <div class="content">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-sm-05.jpg" alt="post categories images">
                                </div>
                                <div class="content">
                    ...
                    <div class="single-cat">
                        <div class="inner">
                            <a href="#">
                                <div class="thumbnail">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-sm-06.jpg" alt="post categories images">
                                </div>
                                <div class="content">
                        ...
                        <div class="row  mt--40">
                            <div class="col-xl-5 col-lg-6 col-md-12 col-12">
                                ...
                                <div class="content-block post-medium post-medium-border border-thin">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('website') }}/assets/images/post-images/post-tech-07.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <div class="post-content">
                                        <div class="post-cat">
                                ...
                                <div class="content-block post-medium post-medium-border border-thin">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('website') }}/assets/images/post-images/post-tech-09.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <div class="post-content">
                                        <div class="post-cat">
                                ...
                                <div class="content-block post-medium post-medium-border border-thin">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('website') }}/assets/images/post-images/post-tech-08.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <div class="post-content">
                                        <div class="post-cat">
                                ...
                                <div class="content-block post-medium post-medium-border border-thin">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('website') }}/assets/images/post-images/post-tech-10.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <div class="post-content">
                                        <div class="post-cat">
                            ...
                            <div class="col-xl-7 col-lg-6 col-md-12 col-12 mt_md--40 mt_sm--40">
                                ...
                                <div class="content-block content-block post-grid post-grid-transparent">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('website') }}/assets/images/post-images/post-tech-06.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <div class="post-grid-content">
                                        <div class="post-content">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-md-6 col-12">
                ...
                <div class="content-block post-default image-rounded mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-dark-01.jpg" alt="Post Images">
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="content-block post-default image-rounded mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-dark-04.jpg" alt="Post Images">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="content-block post-default  image-rounded mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-dark-03.jpg" alt="Post Images">
                                </a>
                                <a class="video-popup size-medium position-top-center" href="post-details.html"><span class="play-icon"></span></a>
                            </div>
                            <div class="post-content">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="content-block post-default image-rounded mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-dark-05.jpg" alt="Post Images">
                                </a>
                                <a class="video-popup size-medium position-top-center" href="post-details.html"><span class="play-icon"></span></a>
                            </div>
                            <div class="post-content">
        ...
        <div class="row">
            <div class="col-lg-8 col-xl-8">
                <div class="axil-banner">
                    <div class="thumbnail">
                        <a href="#">
                            <img class="w-100" src="{{ asset('website') }}/assets/images/add-banner/banner-01.png" alt="Banner Images">
                        </a>
                    </div>
                </div>
                <!-- Start Post List  -->
                <div class="content-block post-list-view is-active mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-test-tech-01.jpg" alt="Post Images">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="post-cat">
                ...
                <div class="content-block post-list-view axil-control mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-test-tech-02.jpg" alt="Post Images">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="post-cat">
                ...
                <div class="content-block post-list-view axil-control mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-test-tech-03.jpg" alt="Post Images">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="post-cat">
                ...
                <div class="content-block post-list-view axil-control mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-test-tech-04.jpg" alt="Post Images">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="post-cat">
                ...
                <div class="content-block post-list-view axil-control mt--30">
                    <div class="post-thumbnail">
                        <a href="post-details.html">
                            <img src="{{ asset('website') }}/assets/images/post-images/post-test-tech-05.jpg" alt="Post Images">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="post-cat">
                    ...
                    <div class="axil-single-widget widget widget_categories mb--30">
                        <ul>
                            <li class="cat-item">
                                <a href="#" class="inner">
                                    <div class="thumbnail">
                                        <img src="{{ asset('website') }}/assets/images/post-images/category-image-01.jpg" alt="">
                                    </div>
                                    <div class="content">
                            ...
                            <li class="cat-item">
                                <a href="#" class="inner">
                                    <div class="thumbnail">
                                        <img src="{{ asset('website') }}/assets/images/post-images/category-image-02.jpg" alt="">
                                    </div>
                                    <div class="content">
                            ...
                            <li class="cat-item">
                                <a href="#" class="inner">
                                    <div class="thumbnail">
                                        <img src="{{ asset('website') }}/assets/images/post-images/category-image-03.jpg" alt="">
                                    </div>
                                    <div class="content">
                                        <h5 class="title">Travel</h5>
                                    </div>
                            ...
                            <li class="cat-item">
                                <a href="#" class="inner">
                                    <div class="thumbnail">
                                        <img src="{{ asset('website') }}/assets/images/post-images/category-image-04.jpg" alt="">
                                    </div>
                                    <div class="content">
                    ...
                    <div class="axil-single-widget widget widget_postlist mb--30">
                        ...
                        <div class="post-medium-block">
                            ...
                            <div class="content-block post-medium mb--20">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="{{ asset('website') }}/assets/images/small-images/blog-sm-01.jpg" alt="Post Images">
                                    </a>
                                </div>
                                <div class="post-content">
                            ...
                            <div class="content-block post-medium mb--20">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="{{ asset('website') }}/assets/images/small-images/blog-sm-02.jpg" alt="Post Images">
                                    </a>
                                </div>
                                <div class="post-content">
                            ...
                            <div class="content-block post-medium mb--20">
                                <div class="post-thumbnail">
                                    <a href="post-details.html">
                                        <img src="{{ asset('website') }}/assets/images/small-images/blog-sm-03.jpg" alt="Post Images">
                                    </a>
                                </div>
                                <div class="post-content">
                    ...
                    <div class="axil-single-widget widget widget_instagram mb--30">
                        ...
                        <ul class="instagram-post-list-wrapper">
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="{{ asset('website') }}/assets/images/small-images/instagram-01.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="{{ asset('website') }}/assets/images/small-images/instagram-02.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="{{ asset('website') }}/assets/images/small-images/instagram-03.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="{{ asset('website') }}/assets/images/small-images/instagram-04.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="{{ asset('website') }}/assets/images/small-images/instagram-05.jpg" alt="Instagram Images">
                                </a>
                            </li>
                            <li class="instagram-post-list">
                                <a href="#">
                                    <img src="{{ asset('website') }}/assets/images/small-images/instagram-06.jpg" alt="Instagram Images">
                                </a>
                            </li>
                        </ul>
                        <!-- End Post List  -->
                ...
                <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="featured-post mt--30">
                                    <div class="content-block">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="#">
                                                <img src="{{ asset('website') }}/assets/images/post-single/featured-post-01.jpg" alt="Post Images">
                            ...
                            <div class="col-lg-6">
                                <div class="featured-post mt--30">
                                    <div class="content-block">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="#">
                                                <img src="{{ asset('website') }}/assets/images/post-single/featured-post-02.jpg" alt="Post Images">
                                                <div class="review-count">
                                                    <span>8</span>
                                                </div>
                                            </a>
                    ...
                    <div class="col-lg-8 col-xl-8 mt--30">
                        ...
                        <div class="content-block post-list-view with-bg-solid mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-tech-11.jpg" alt="Post Images">
                                    <div class="review-count">
                                        <span>7.4</span>
                                    </div>
                                </a>
                        ...
                        <div class="content-block post-list-view with-bg-solid mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-tech-12.jpg" alt="Post Images">
                                    <div class="review-count">
                                        <span>5</span>
                                    </div>
                                </a>
                        ...
                        <div class="content-block post-list-view with-bg-solid mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-tech-13.jpg" alt="Post Images">
                                    <div class="review-count">
                                        <span>5</span>
                                    </div>
                                </a>
                        ...
                        <div class="content-block post-list-view with-bg-solid mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('website') }}/assets/images/post-images/post-tech-14.jpg" alt="Post Images">
                                    <div class="review-count">
                                        <span>5.5</span>
                                    </div>
                                </a>
                            ...
                            <div class="axil-single-widget widget-style-2 widget widget_post mt--30">
                                ...
                                <div class="video-post-wrapepr">
                                    ...
                                    <div class="content-block image-rounded">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('website') }}/assets/images/post-single/post-md-01.jpg" alt="Post Images">
                                            </a>
                                    ...
                                    <div class="content-block image-rounded mt--20">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('website') }}/assets/images/post-single/post-md-02.jpg" alt="Post Images">
                                            </a>
                                            <a class="video-popup size-medium position-top-center icon-color-secondary" href="post-details.html"><span class="play-icon"></span></a>
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="content-block image-rounded mt--20">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('website') }}/assets/images/post-single/post-md-03.jpg" alt="Post Images">
                                            </a>
                                            <a class="video-popup size-medium position-top-center icon-color-secondary" href="post-details.html"><span class="play-icon"></span></a>
                                        </div>
                                        <div class="post-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="axil-banner mt--30">
                    <div class="thumbnail">
                        <a href="#">
                            <img class="w-100" src="{{ asset('website') }}/assets/images/add-banner/banner-03.png" alt="Banner Images">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <ul class="instagram-post-list">
                    <li class="single-post">
                        <a href="#">
                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-06.jpg" alt="Instagram Images">
                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                        </a>
                    </li>
                    <li class="single-post">
                        <a href="#">
                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-07.jpg" alt="Instagram Images">
                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                        </a>
                    </li>
                    <li class="single-post">
                        <a href="#">
                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-08.jpg" alt="Instagram Images">
                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                        </a>
                    </li>
                    <li class="single-post">
                        <a href="#">
                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-09.jpg" alt="Instagram Images">
                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                        </a>
                    </li>
                    <li class="single-post">
                        <a href="#">
                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-10.jpg" alt="Instagram Images">
                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                        </a>
                    </li>
                    <li class="single-post">
                        <a href="#">
                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-11.jpg" alt="Instagram Images">
                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                        </a>
                    </li>
                </ul>
