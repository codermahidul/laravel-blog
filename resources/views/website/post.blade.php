                    ...
                    <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="content-block">
                                            ...
                                            <div class="post-content">
                                                ...
                                                <h1 class="title">Apple honors eight
                                                    developers with annual Apple Design Awards</h1>
                                                <!-- Post Meta  -->
                                                <div class="post-meta-wrapper">
                                                    <div class="post-meta">
                                                        <div class="post-author-avatar border-rounded">
                                                            <img src="{{ asset('website') }}/assets/images/post-images/author/author-image-3.png" alt="Author Images">
                                                        </div>
                                                        <div class="content">
                        ...
                        <div class="axil-post-details">
                            ...
                            <figure class="wp-block-image">
                                <img src="{{ asset('website') }}/assets/images/post-single/post-single-05.jpg" alt="Post Images">
                            ...
                            <figure class="wp-block-image">
                                <img src="{{ asset('website') }}/assets/images/post-single/post-single-03.jpg" alt="Post Images">
                                <figcaption>The Apple Design Award trophy, created by the Apple Design team, is a symbol
                                    of achievement and excellence.</figcaption>
                            </figure>
                            <h2>Apple Design Award Winners: Apps</h2>
                            ...
                            <p>“Every year, app and game developers demonstrate exceptional craftsmanship and we’re
                                ...
                                at Apple, too.”</p>
                            <figure class="wp-block-image">
                                <img src="{{ asset('website') }}/assets/images/post-single/post-single-04.jpg" alt="Post Images">
                                <figcaption>The Apple Design Award trophy, created by the Apple Design team, is a symbol
                                    of achievement and excellence.</figcaption>
                            </figure>
                            ...
                            <div class="about-author">
                                <div class="media">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img src="{{ asset('website') }}/assets/images/post-images/author/author-b1.png" alt="Author Images">
                                        </a>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-inner">
                            ...
                            <div class="axil-single-widget widget widget_ads mb--30">
                                ...
                                <div class="thumbnail">
                                    <a href="#">
                                        <img src="{{ asset('website') }}/assets/images/post-single/ads-01.jpg" alt="Ads Images">
                                    </a>
                                </div>
                                <!-- End Post List  -->
                            </div>
                            ...
                            <div class="axil-banner">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img class="w-100" src="{{ asset('website') }}/assets/images/add-banner/banner-02.png" alt="Banner Images">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <ul class="instagram-post-list">
                                    <li class="single-post">
                                        <a href="#">
                                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-01.jpg" alt="Instagram Images">
                                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                        </a>
                                    </li>
                                    <li class="single-post">
                                        <a href="#">
                                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-02.jpg" alt="Instagram Images">
                                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                        </a>
                                    </li>
                                    <li class="single-post">
                                        <a href="#">
                                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-03.jpg" alt="Instagram Images">
                                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                        </a>
                                    </li>
                                    <li class="single-post">
                                        <a href="#">
                                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-04.jpg" alt="Instagram Images">
                                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                        </a>
                                    </li>
                                    <li class="single-post">
                                        <a href="#">
                                            <img src="{{ asset('website') }}/assets/images/small-images/instagram-md-05.jpg" alt="Instagram Images">
                                            <span class="instagram-button"><i class="fab fa-instagram"></i></span>
                                        </a>
                                    </li>
                                    <li class="single-post">
