...
<!-- Mirrored from axilthemes.com/demo/template/blogar/home-tech-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Dec 2021 12:44:59 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Tech Blog || Blogar - Personal Blog Template</title>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="logo">
                                <a href="{{route('index')}}">
                                    <img class="dark-logo" src="{{ asset('website') }}/assets/images/logo/logo-black.png" alt="Logo Images">
                                    <img class="light-logo" src="{{ asset('website') }}/assets/images/logo/logo-white2.png" alt="Logo Images">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-9 col-md-8 col-sm-6">
                            <div class="banner-add text-end">
                                <a href="#">
                                    <img src="{{ asset('website') }}/assets/images/others/add-01.png" alt="Add images">
                                </a>
                            </div>
                        </div>
                    </div>
                                                                        ...
                                                                        <div class="content-block image-rounded">
                                                                            <div class="post-thumbnail mb--20">
                                                                                <a href="post-details.html">
                                                                                    <img class="w-100" src="{{ asset('website') }}/assets/images/others/mega-post-01.jpg" alt="Post Images">
                                                                                </a>
                                                                            </div>
                                                            ...
                                                            <span data-text="DESIGN">DESIGN</span>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="content-block image-rounded">
                                                                            <div class="post-thumbnail mb--20">
                                                                                <a href="post-details.html">
                                                                                    <img class="w-100" src="{{ asset('website') }}/assets/images/others/mega-post-02.jpg" alt="Post Images">
                                                                                </a>
                                                                            </div>
                                                                            <div class="post-content">
                                                                                <div class="post-cat">
                                                            ...
                                                            <span data-text="CREATIVE">CREATIVE</span>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="content-block image-rounded">
                                                                            <div class="post-thumbnail mb--20">
                                                                                <a href="post-details.html">
                                                                                    <img class="w-100" src="{{ asset('website') }}/assets/images/others/mega-post-03.jpg" alt="Post Images">
                                                                                </a>
                                                                            </div>
                                                                            <div class="post-content">
                                                                                <div class="post-cat">
                                                            ...
                                                            <span data-text="TRAVEL">TRAVEL</span>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="content-block image-rounded">
                                                                            <div class="post-thumbnail mb--20">
                                                                                <a href="post-details.html">
                                                                                    <img class="w-100" src="{{ asset('website') }}/assets/images/others/mega-post-04.jpg" alt="Post Images">
                                                                                </a>
                                                                            </div>
                                                                            <div class="post-content">
                                                                                <div class="post-cat">
                        ...
                        <div class="col-xl-5">
                            <div class="header-search d-flex align-items-center justify-content-xl-end justify-content-center">
                                ...
                                <ul class="metabar-block">
                                    ...
                                    <li><a href="#"><img src="{{ asset('website') }}/assets/images/others/author.png" alt="Author Images"></a></li>
                                </ul>
...
<!-- Mirrored from axilthemes.com/demo/template/blogar/home-tech-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Dec 2021 12:45:30 GMT -->
</html>